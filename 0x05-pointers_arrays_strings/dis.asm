...
0000000000400400 <_init>:
  ...
  400404:	48 8b 05 ed 0b 20 00 	mov    rax,QWORD PTR [rip+0x200bed]        # 600ff8 <__gmon_start__>
...
0000000000400440 <printf@plt>:
  400440:	ff 25 da 0b 20 00    	jmp    QWORD PTR [rip+0x200bda]        # 601020 <printf@GLIBC_2.2.5>
  400446:	68 01 00 00 00       	push   0x1
  40044b:	e9 d0 ff ff ff       	jmp    400420 <.plt>

0000000000400450 <__libc_start_main@plt>:
  400450:	ff 25 d2 0b 20 00    	jmp    QWORD PTR [rip+0x200bd2]        # 601028 <__libc_start_main@GLIBC_2.2.5>
...
0000000000400460 <__gmon_start__@plt>:
  400460:	ff 25 92 0b 20 00    	jmp    QWORD PTR [rip+0x200b92]        # 600ff8 <__gmon_start__>
